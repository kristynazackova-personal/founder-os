...
export async function GET(request: NextRequest) {
  ...
  if (!stripeConnectConfigured()) return NextResponse.redirect(new URL(`/app/${app.id}/connect/stripe?error=${encodeURIComponent("Stripe Connect is not configured.")}`, request.url));
